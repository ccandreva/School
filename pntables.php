...
function School_pntables()
{
	...
	'Religion'              => 'School_family_Religion',
	'Parish'        	=> 'School_family_Parish',
	...
	'PreviousSchool' =>	'School_register_PreviousSchool',
	'PreviousSchoolAddress' =>	'School_register_PreviousSchoolAddress',
        ...
        'ChooseRecommend'    =>  'School_register_ChoseRecommend',
        'ChooseOther'    =>  'School_register_ChoseOther',
    ...
    $table['School_register_column_def'] = array(
        ...
        'Parishioner'   =>      'L',
        'EnvelopeNumber'   =>   'I',
	'PreviousSchool' =>	'C(255)',
	'PreviousSchoolAddress' =>	'C(255)',
        'ChooseMont'    =>  'L',
        'ChooseCatholic'    =>  'L',
        'ChooseOtherKids'    => 'L',
        'ChooseRecommend'    =>  'C(255)',
        'ChooseOther'    =>  'C(255)',
