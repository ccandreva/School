...
function School_pntables()
{
    ...
    //Emergency form table
    //$table['School_emergencyform'] = DBUtil::getLimitedTablename('School_emergencyform');
    //$table['School_emergencyStudent'] = DBUtil::getLimitedTablename('School_emergencyStudent');
 ...
 /*
    $table['School_emergencyform_column'] = array(
        'id'        => 'School_emergencyform_id',
	'LastName'		=> 'School_emergencyform_LastName',
	'Phone'		=> 'School_emergencyform_Phone',
	'BusNumber'		=> 'School_emergencyform_BusNumber',
	'Address'		=> 'School_emergencyform_Address',
	'Apt'		=> 'School_emergencyform_Apt',
	'City'		=> 'School_emergencyform_City',
	'State'		=> 'School_emergencyform_State',
	'Zip'		=> 'School_emergencyform_Zip',
	'MotherName'		=> 'School_emergencyform_MotherName',
	'MotherWorkAddress'		=> 'School_emergencyform_MotherWorkAddress',
        'MotherWorkCityStateZip'    => 'School_emergencyform_MotherWorkCityStateZip',
	'MotherPhone'		=> 'School_emergencyform_MotherPhone',
	'MotherCell'		=> 'School_emergencyform_MotherCell',
	'FatherName'		=> 'School_emergencyform_FatherName',
	'FatherWorkAddress'		=> 'School_emergencyform_FatherWorkAddress',
        'FatherWorkCityStateZip'    => 'School_emergencyform_FatherWorkCityStateZip',
	'FatherPhone'		=> 'School_emergencyform_FatherPhone',
	'FatherCell'		=> 'School_emergencyform_FatherCell',
	'DoctorName'		=> 'School_emergencyform_DoctorName',
	'DoctorAddress'		=> 'School_emergencyform_DoctorAddress',
	'DoctorPhone'		=> 'School_emergencyform_DoctorPhone',
	'DentistName'		=> 'School_emergencyform_DentistName',
	'DentistAddress'		=> 'School_emergencyform_DentistAddress',
	'DentistPhone'		=> 'School_emergencyform_DentistPhone',
	'OrthodontistName'		=> 'School_emergencyform_OrthodontistName',
	'OrthodontistAddress'		=> 'School_emergencyform_OrthodontistAddress',
	'OrthodontistPhone'		=> 'School_emergencyform_OrthodontistPhone',
    );


    $table['School_emergencyform_column_def'] = array(
    ...
    ObjectUtil::addStandardFieldsToTableDefinition(
            $table['School_emergencyform_column'],
            'School_emergencyform_'
            );
    ObjectUtil::addStandardFieldsToTableDataDefinition(
            $table['School_emergencyform_column_def']
            );

    $table['School_emergencyStudent_column'] = array(
        'id'                => 'school_emergencyStudent_id',
        'familyid'                => 'school_emergencyStudent_familyid',
        'StudentName'       => 'school_emergencyStudent_StudentName',
        'Grade'     => 'school_emergencyStudent_Grade',
        'DOB'       => 'school_emergencyStudent_DOB',
        'Teacher'       => 'school_emergencyStudent_Teacher',
        'Allergies'       => 'school_emergencyStudent_Allergies',
        'Conditions'       => 'school_emergencyStudent_Conditions',
    );

    $table['School_emergencyStudent_column_def'] = array(
